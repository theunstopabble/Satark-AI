    ...
    if (!PUBLISHABLE_KEY) {
        return (
            <div className="flex bg-destructive/10 h-screen items-center justify-center flex-col gap-4 p-4 text-center">
                <h1 className="text-4xl font-bold text-destructive">Configuration Error</h1>
                <p className="text-lg">Missing <code>VITE_CLERK_PUBLISHABLE_KEY</code></p>
            </div>
        );
    }
                    ...
                    <Route
                        ...
                        element={
                            <>
                                ...
                                <SignedOut><RedirectToSignIn afterSignInUrl="/dashboard" /></SignedOut>
                            </>
                        }
                    />
                    <Route
